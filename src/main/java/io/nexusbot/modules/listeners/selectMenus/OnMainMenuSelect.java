        ...
        MessageEmbed embed = new EmbedBuilder()
                ...
                .setDescription("""
                        - Для создания или изменения настроек уже текущего канала-создателя пропишите `/setup rooms save`
                            **Выдайте боту право на изменения статуса канала. Этого права нет в панели выбора прав бота, поэтому приходится делать вручную.**
                            Выберите канал, в который нужно зайти, чтобы создать новую комнату.
                            Выберите категорию, в которой будет создана новая комната.
                            **Для исключения ошибок вручную выдайте право "Управлять правами" боту в выбранной категории**
